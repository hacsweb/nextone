            ...
            >
              ...
              >
                <motion.a
                  ...
                  className="text-white px-8 py-4 rounded-full flex items-center justify-center relative overflow-hidden group cursor-pointer transition-all duration-300 whitespace-nowrap"
                  style={{
                    fontWeight: 700,
