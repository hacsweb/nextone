...
import recruitPhoto from "../../assets/d5ee6c8838fc3fb2a3f016235f2db0896ff70321.png";
import startupPhoto from "../../assets/2ecacb8412f772d8e188af8b8a791d9f1069bf69.png";
import {
  fadeInUp,
  staggerContainer,
  viewportOnce,
    ...
    >
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="flex items-center flex-wrap sm:flex-nowrap justify-center mb-5 gap-x-0.5 sm:gap-x-1 gap-y-2">
          {badges.map((b, i) => {
            const brightColors: Partial<Record<ServiceKey, { main: string; rgb: string }>> = {
              tech: { main: "#34d399", rgb: "52, 211, 153" },
              web: { main: "#ef4444", rgb: "239, 68, 68" },
              photo: { main: "#3b82f6", rgb: "59, 130, 246" },
              car: { main: "#a855f7", rgb: "168, 85, 247" },
            };
            const c = brightColors[b.colorKey] ?? COLORS[b.colorKey];
            return (
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 max-w-xl mx-auto"
          variants={staggerContainer}
        >
          {([
            {
            ...
            const c = svc.colorKey === "photo"
              ? { main: "#3b82f6", rgb: "59, 130, 246" }
              : svc.colorKey === "car"
              ? { main: "#a855f7", rgb: "168, 85, 247" }
              : COLORS[svc.colorKey];
            return (
              <motion.div key={svc.name} variants={fadeInUp} className="aspect-square">
                <Link
                  to={svc.path}
                  className="group flex flex-col items-center justify-center rounded-lg text-center transition-all duration-400 no-underline relative overflow-hidden w-full h-full"
                  style={{
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.borderColor = `rgba(${c.rgb}, 0.55)`;
                    e.currentTarget.style.backgroundColor =
                      "rgba(255,255,255,0.08)";
                    e.currentTarget.style.transform = "translateY(-2px)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = `rgba(${c.rgb}, 0.25)`;
                    e.currentTarget.style.backgroundColor =
                ...
                >
                  ...
                  {svc.badge ? (
                    <span
                      className="inline-block text-[13px] px-3 py-1 tracking-wider"
                      style={{
                        fontFamily: "'Space Grotesk', sans-serif",
                        fontWeight: 600,
                        color: c.main,
                    ...
                    <span
                      className="inline-flex items-center gap-1 text-[15px] transition-all duration-300"
                      style={{
                        fontFamily: "'Noto Sans JP', sans-serif",
                        fontWeight: 600,
